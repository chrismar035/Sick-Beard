...
USE_PUSHSOMETHING = False
PUSHSOMETHING_NOTIFY_ONSNATCH = False
PUSHSOMETHING_NOTIFY_ONDOWNLOAD = False
PUSHSOMETHING_SERVICE_TOKEN = None
...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                USE_PUSHSOMETHING, PUSHSOMETHING_NOTIFY_ONSNATCH, PUSHSOMETHING_NOTIFY_ONDOWNLOAD, PUSHSOMETHING_SERVICE_TOKEN, \
